    ...
    <section className="bg-[#0e3b77] text-white overflow-hidden">
      <div className="container-main">
        <div className="max-w-[760px] mx-auto pt-10 pb-12 md:pt-16 md:pb-20 lg:pt-20 lg:pb-24 text-center">
          ...
          {/* Headline */}
          <h1 className="mt-2 sm:mt-3 font-display font-extrabold text-white leading-[1.12] tracking-tight text-[28px] sm:text-[34px] md:text-[42px] lg:text-[50px]">
            An Economical and Resourceful Alternative to UWorld &amp; Many
            Other Expensive Qbanks.
          </h1>

          {/* Body 1 */}
          <p className="mt-5 sm:mt-6 text-[14px] sm:text-[15px] md:text-base text-blue-100/90 leading-relaxed max-w-[640px] mx-auto">
            Get Access to{' '}
            ...
            for{' '}
            <strong className="font-bold text-white">
              USMLE, PLAB, AMC, MCCQE, UKMLA, SMLE, and more.
            </strong>
          </p>

          {/* Body 2 */}
          <p className="mt-4 text-[14px] sm:text-[15px] md:text-base text-blue-100/90 leading-relaxed max-w-[640px] mx-auto">
            Includes{' '}
            <strong className="font-bold text-white">
          ...
          {/* Activation tag */}
          <p className="mt-6 sm:mt-7 text-[14px] sm:text-[15px] md:text-base font-semibold text-white">
